...
class Puzzle3x3:
    def _init_(self):
        self.board = [num for row in GOAL for num in row]  # Flattened board
...
def play():
    puzzle = Puzzle3x3()
    print("Solve the 3-Puzzle Game!")
    while not puzzle.is_solved():
        puzzle.display()
        puzzle.move(input("Move (up/down/left/right): ").strip().lower())
